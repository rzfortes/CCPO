...
function getAnnouncement() {
  ...
  /* RETRIEVE */
      ...
      // to limit up to 10 only, add: .limitToLast(10)
        ...
        roofRef.orderByChild("date").equalTo(input_date).on("child_added", snap => {
        // console.log(input_date);
        // var name = snap.child("Name").val();
        // var email = snap.child("Email").val();
        // var nd = new Date(snap.child("date").val())
        // var mo = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 
        // 'August', 'September', 'October', 'November', 'December']
      
        // var selected_date = nd.getDate() + " " + mo[nd.getMonth()] + ", " + nd.getFullYear()
       
        // if(input_date === selected_date){
